...
public class MultipleVariableDecl extends MultipleVarDecl {

    private MultipleVarDecl MultipleVarDecl;
    private VarDecl VarDecl;

    public MultipleVariableDecl (MultipleVarDecl MultipleVarDecl, VarDecl VarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleVariableDecl(\n");
